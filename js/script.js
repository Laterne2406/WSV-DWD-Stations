...
function closeWindbox() {
   document.getElementById("tester2").innerHTML = "Häufige Windrichtung";
};
...
fetch(test_url)
	...
	.then(data => {
		...
		var result3 = `<button onclick='closeWindbox()'> clear box</button><br/>`
		document.getElementById('tester2').innerHTML = result3
